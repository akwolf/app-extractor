...
public class ImageNTHeaders {
	...
	if (i < 0 || i > sections.length) {
	    throw new IllegalArgumentException("Illegal NT image section header index: " + i);
	}
	return sections[i];
    }
     ...
     *
     * @param ide A number between 1 and 15, corresponding to the desired ImageDataDirectory._TABLE constant.
     */
     ...
     *
     * @param ide int from from jpe.ImageDataDirectory.[X]_TABLE constants.
     */
